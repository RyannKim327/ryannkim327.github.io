    ...
    >
      ...
      {props.even && (
        <div className="flex justify-end w-1/2 pr-6">
          <div className="bg-slate-300 border-slate-900 text-black dark:bg-slate-900 border dark:border-slate-500 dark:border-solid dark:text-white p-4 rounded-lg w-100">
