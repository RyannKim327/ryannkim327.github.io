    ...
    >
      ...
      >
        {_blogs && _blogs.length > 0 ? (
          _blogs.map((blog: blogs) => {
            return (
              ...
              >
                <div className="flex flex-col bg-taupe-300 text-taupe-900 p-4 rounded-lg w-full h-full overflow-hidden gap-1">
        ...
        <Link
          ...
          className="w-full md:w-[calc(25%-0.5rem)] aspect-video"
        >
          <div className="flex flex-col bg-taupe-300 text-taupe-900 items-center justify-center text-center p-4 rounded-lg w-full h-full overflow-hidden gap-1">
