  ...
  return (
    <AdminController>
      <div className="flex flex-col md:flex-row justify-center items-center p-4 bg-[#f6f6f6] text-black dark:bg-[#0c0c0c] dark:text-white w-dvw h-dvh gap-2 select-none">
        <div
          className={`flex flex-col ${toggle ? "h-15 overflow-y-hidden" : "h-1/2"} transition-all delay-150 md:h-full w-full md:w-1/6 justify-between bg-zinc-300 text-black dark:bg-slate-800 dark:text-white p-5 rounded`}
        >
