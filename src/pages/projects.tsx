        ...
        {Images().map((item) => {
          return (
            <div
              ...
              className="flex flex-col justify-center items-center grayscale hover:grayscale-0 w-full h-full bg-center bg-cover bg-no-repeat bg-fixed box-border overflow-hidden rounded transition ease-all delay-150"
            >
              {/* <img */}
              ...
              {/*   src={item.src} */}
              {/* /> */}
              <span className="flex flex-col justify-center items-center text-white bg-black/50 mt-[-30px] px-2 backdrop-blur box-border">
