  ...
  let chats = $state([
    {
      role: "system",
      content:
        "Hello, this is Krysanne Guinmods, the AI for this portfolio, if you want to know something about Ryann Kim, just ask and I will answer.",
    },
  ]);
    ...
    >
      <div class="flex justify-between">
        <div class="flex flex-col">
          <span>k.guin</span>
          <span>Powered by Google Gemma 4</span>
        </div>
        <span
          onclick={() => {
            show = false;
